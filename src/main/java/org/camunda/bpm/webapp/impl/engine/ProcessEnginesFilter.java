...
public class ProcessEnginesFilter extends AbstractTemplateFilter {
  ...
  protected static final String CASELIST_APP_NAME = "caselist";
  ...
  protected final CaselistRuntimeDelegate caselistRuntimeDelegate;
  ...
  public ProcessEnginesFilter() {
    ...
    this.caselistRuntimeDelegate = Caselist.getRuntimeDelegate();
  ...
  protected void serveIndexPage(String appName,
    ...
    System.out.println("getting contents of appName: "+appName);
  ...
  protected <T extends AppPlugin> List<T> getPlugins(String appName) {
    ...
    } else if (CASELIST_APP_NAME.equals(appName)) {
      return (List<T>) caselistRuntimeDelegate.getAppPluginRegistry().getPlugins();
